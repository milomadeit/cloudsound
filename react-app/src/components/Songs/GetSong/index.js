...
import { add_song_to_pl } from "../../../store/playlist-songs";
...
{user && (<div><CreateSongComment /></div>)}
    ...
    {user.id===song.user_id &&<span><button id="button-for-add-to-playlist-song-details-page" onClick={(e)=>handleClickAddToPlaylist(e)}><img id="logo2"src={addplaylist} style={{width:"20px", height:"20px"}}/></button></span>}
